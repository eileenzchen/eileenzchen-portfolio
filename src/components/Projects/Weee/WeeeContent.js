...
export function Inspiration() {
  return (
    <div id="Inspiration" className="project-section">
      ...
      <p>
        <b>I grew up loving to grocery shop.</b> Every weekend, my mom and I went to 99 Ranch (an Asian supermarket) and Costco. We perused the aisles for the newest ice cream and fresh pastries, checked the store magazines for the best sales, and ran into neighbors and friends who told us about their good finds.
      </p>
      <p>
...
export function CompetitiveAnalysis() {
  return (
    <div id="CompetitiveAnalysis" className="project-section">
      ...
      <p>
        With this comparison, I noticed the <b>differences between apps that target different cultures</b>. One of Weee!'s primary audiences is its Chinese-speaking base. Chinese apps often condense a lot of text into small areas because Chinese characters are compact and succinct. However, <b>when translated, Chinese characters evolve into lengthy English words that overwhelm the user</b>. American apps often focus more on minimal text since English words are lengthy. With Weee!'s intention to expand their market to more second and third generation Americans, I focused on <b>minimal text</b> and using media to speak for itself.
      </p>
    </div>
  )
}
